...
namespace BeautyStudioSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [Display(Name = "Phone, e.g. 0123456789")]
            [StringLength(InputValidations.PhoneLength)]
            [MinLength(InputValidations.PhoneLength, ErrorMessage = "Phone number must be exactly 10 digits")]
